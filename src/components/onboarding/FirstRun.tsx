 ...
 *
 * **The body of the deck, and nothing around it.** The layer it sits in — over
 * everything, opaque, forced light — belongs to `FirstRunFlow`, which owns the
 * launch screen as well and on a wide window draws the two side by side. So
 * this renders a column and lets its container decide whether that column is a
 * phone screen or a card on the right of one.
 *
