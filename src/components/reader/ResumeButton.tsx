...
export function ResumeButton({
  ...
  return (
    <Link
      href={href}
      className="flex h-12 flex-1 items-center justify-center gap-2 rounded-tile bg-card px-4 text-sm font-semibold text-ink shadow-[0_8px_18px_-8px_rgba(0,0,0,.5)] transition-transform active:scale-[.98]"
    >
